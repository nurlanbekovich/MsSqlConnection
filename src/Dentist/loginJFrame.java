...
public class loginJFrame extends javax.swing.JFrame {
    ...
    private void jbtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnLoginActionPerformed
        // TODO add your handling code here:
//          if (txtPassword.getText().equals("BA")){
//                JOptionPane.showMessageDialog(null, "Успешно Авторизован!!!");
...
//            }
        try{
            ...
            String sql = "Select * from Table_doctor where Login=? and Password = ?";
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "Ошибка Логин или пароль неверный!!!");
                              txtLogin.setText("");
                             txtPassword.setText("");
            }
            con.close();
