 ...
 * @author Aidin
 */
public class directory1 extends javax.swing.JInternalFrame {
Connection conn = null;
CallableStatement stored_pro = null;
Statement statement = null;
ResultSet rs = null;
    /**
     * Creates new form directory1
     */
    public directory1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MeasureInsertButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\Aidin\\Downloads\\Employee Payroll\\Employee Payroll\\Icons\\Save-icon.png")); // NOI18N
        ...
        MeasureUpdateButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\Aidin\\Downloads\\Employee Payroll\\Employee Payroll\\Icons\\attach.png")); // NOI18N
        ...
        addres.setRows(5);
        jScrollPane2.setViewportView(addres);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql = "SELECT  [ID]\n" +
            "      ,[Name]\n" +
            "      ,[Description] from [dbo].[directory]";
            statement = conn.createStatement();
            rs = statement.executeQuery(sql);
            this.jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            jTable1.getColumnModel().getColumn(0).setHeaderValue("ID");
...
"      ,[Description] from [dbo].[directory]";
    ...
    private void MeasureInsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MeasureInsertButtonActionPerformed
        ...
        try{
            conn = ConnectMsSql.ConnectDB();
            stored_pro = conn.prepareCall("{call [insert_date_about_directory] (?,?)}");
    ...
    private void MeasureUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MeasureUpdateButtonActionPerformed
        ...
        try{
            conn = ConnectMsSql.ConnectDB();
            stored_pro = conn.prepareCall("{call [update_data_about_directory] (?,?,?)}");
    ...
    private void MeasureDeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MeasureDeleteButtonActionPerformed
        ...
        {
            stored_pro = conn.prepareCall("{call [delete_date_about_directory] (?)}");
            stored_pro.setString(1, this.IDtxt.getText());
            stored_pro.execute();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try{
            ...
            String sql = "SELECT [ID],[Name],[Description] from [directory] where ID ='" + name + "'";
            ...
            while(rs.next()){
                ...
                addres.setText(rs.getString("Description"));
