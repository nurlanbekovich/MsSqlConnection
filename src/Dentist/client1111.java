 ...
 * @author Aidin
 */
public class client1111 extends javax.swing.JInternalFrame {
...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        diagtxt.setToolTipText("");

        doctxt.setToolTipText("");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(diagtxt, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(10, 10, 10)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel12)
                            .addComponent(doctxt, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(20, 20, 20)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
...
"     INNER JOIN \"dbo\".\"Table_doctor\" Table_doctor ON Appointment_Doctor.\"Леч_врач\" = Table_doctor.\"ID\"";
    ...
    private void MeasureInsertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MeasureInsertButtonActionPerformed
        // TODO add your handling code here:
         ...
         int diag = Integer.parseInt(senatxt.getText());
         int docto = Integer.parseInt(senatxt.getText());
        ...
        String dobavlenie = "INSERT INTO Appointment_Doctor (ФИО,Диагноз,Диагноз,Посещение,Леч_врач) VALUES (?,?,?,?,?)";
...
//            stored_pro.setString(3, this.Email.getText());
    ...
    private void MeasureUpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MeasureUpdateButtonActionPerformed
        ...
        int idfio = 0;
            ...
            stored_pro = conn.prepareCall("{call update_data_about_Appointment (?,?,?,?,?,?,?)}");
             stored_pro.setInt(1, id2);
            stored_pro.setInt(2, idfio);
            stored_pro.setInt(3, iddiag); 
            stored_pro.setDate(4, startDate);
            stored_pro.setInt(5, sena);
            stored_pro.setInt(6, poss);
           
            stored_pro.setInt(7, iddoc);
...
//            stored_pro.setString(4, this.senatxt.getText());
//            stored_pro.setString(5, this.pos.getText());
...
diagtxt.setText(model.getValueAt(i,2).toString());
    ...
    doctxt.setText(model.getValueAt(i,6).toString());
